...
class Login extends React.Component {
  ...
  render() {
    return (
      ...
      <h3>Epic Battle Game is a free-to-play, turn-based card battle game where you may </h3>
      <h3>pit your own custom-made characters against the universe's toughest foes!</h3>
      <h3>Simply sign up/login to continue, and begin your Epic Battle now!</h3>
      </div>
    )
  }
}
